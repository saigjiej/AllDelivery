...
from WeightSelection import WeightSelection


class RegisteredParcel(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setupUI()
    ...
    def setupUI(self):
        ...
        btn1.move(770, 445)
        btn1.resize(130, 60)
        btn1.clicked.connect(self.WeightSelection)

    def WeightSelection(self):
        self.close()
        self.WeightSelection.show()
